			...
			<div id="footer">
				<div id="footer-content" class="typography">
					...
					<ul>
						...
						<% end_control %>
						<!--<li><a href="http://www.linkedin.com/pub/craig-just/26/202/634"><img src="http://craigjust.org/assets/social-l_2.png" border="0"></a>
						<a href=""><img src="http://imu.uiowa.edu/themes/imu4/images/social-twitter.png" border="0"></a>
						<a href=""><img src="http://imu.uiowa.edu/themes/imu4/images/social-facebook.png" border="0"></a>
						<img src="$ThemeDir/images/facebook.png" /><br /><img src="$ThemeDir/images/twitter.png" />
						</li>-->
					</ul>
